...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="left-content">
            <div>
                <h2 class="main-content-title tx-24 mg-b-1 mg-b-lg-1 d-flex">{{ __('main.Welcome Back') }}{{ Auth::user()->name }} <div
                        class="hand">👋</div>
                </h2>
        ...
        <div class="main-dashboard-header-right">
            <div>
                <label class="tx-13">{{ __('side_bar.Single Service') }}</label>
                <h5 class="text-center">{{ \App\Models\Service::count() }}</h5>
            </div>
            <div>
                <label class="tx-13">{{ __('side_bar.Group Service') }}</label>
                <h5 class="text-center">{{ \App\Models\Group::count() }}</h5>
            </div>
        </div>
    </div>
    <!-- /breadcrumb -->
    ...
    <div class="row row-sm">
        <div class="col-xl-4 col-lg-6 col-md-6 col-xm-12">
            <div class="card overflow-hidden sales-card bg-primary-gradient">
                <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                    <div class="">
                        <h6 class="mb-3 tx-12 text-white">{{ __('main.Number Of Doctor') }}</h6>
                    </div>
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
        ...
        <div class="col-xl-4 col-lg-6 col-md-6 col-xm-12">
            <div class="card overflow-hidden sales-card bg-danger-gradient">
                <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                    <div class="">
                        <h6 class="mb-3 tx-12 text-white">{{ __('main.Number Of Patient') }}</h6>
                    </div>
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
        ...
        <div class="col-xl-4 col-lg-6 col-md-6 col-xm-12">
            <div class="card overflow-hidden sales-card bg-success-gradient">
                <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                    <div class="">
                        <h6 class="mb-3 tx-12 text-white">{{ __('main.Number Of Section') }}</h6>
                    </div>
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
