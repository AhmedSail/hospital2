...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">{{ __('side_bar.List Of Reviews') }}</h4><span
                        ...
                        <table class="table text-md-nowrap" id="example1">
                            <thead>
                                <tr>
                                    ...
                                    <th>{{ __('doctor/invoices.Date Of Review') }}</th>
                            ...
                            <tbody>
                                @foreach ($invoices as $invoice)
                                    <tr>
                                        ...
                                        <td>{{ App\Models\Diagnosis::where(['invoice_id' => $invoice->id])->first()->review_date }}
                                        </td>
                                        <td>
                                    ...
                                    <div class="modal fade" id="transfer_x_ray{{ $invoice->id }}"
                                    ...
                                    <div class="modal fade" id="laboratorie_conversion{{ $invoice->id }}"
                                        data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                                        aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                    ...
                                    {{-- <div class="modal fade" id="delete{{ $invoice->id }}" data-bs-backdrop="static"
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                ...
                                                <form action="{{ route('Diagnosis.destroy', $invoice->id) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('delete')
                                                    <div class="modal-body">
