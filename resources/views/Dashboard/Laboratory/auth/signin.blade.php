                                ...
                                <div class="card-sigin">
                                    ...
                                    <div class="card-sigin">
                                        <div class="main-signup-header">
                                            <h2>{{ __('main.Welcome Back') }} {{ __('main.Laboratory Employee') }}</h2>
                                            <h5 class="font-weight-semibold mb-4">
                                                {{ __('main.Please sign in to continue') }}</h5>
                                            <div class="" id="laboratory_employee">
                                                <form action="{{ route('login.action') }}" method="POST">
                                                    @csrf
                                                    <input type="hidden" name="guard" value="laboratory_employee">
                                                    <div class="form-group">
                                                        <label>{{ __('doctor.Email') }}</label>
                                                        <input name="email" placeholder="{{ __('doctor.Email') }}" type="email"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input name="password"
                                                            ...
                                                            is-invalid
                                                        @enderror"
                                                            placeholder="{{ __('doctor.Password') }}" type="password"
