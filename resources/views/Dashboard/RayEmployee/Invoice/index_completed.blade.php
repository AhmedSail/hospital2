                        ...
                        <table class="table text-md-nowrap" id="example1">
                            ...
                            @foreach($rays as $ray)
                                <tr>
                                    ...
                                    <td><a href="{{ route('invoice.show',$ray->id) }}">{{ $ray->Patient->name }}</a></td>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu tx-13">
                                                <a class="dropdown-item" href="{{ route('invoice.edit',$ray->id) }}"><i class="text-primary fa fa-stethoscope"></i>&nbsp;&nbsp;{{ __('doctor/invoices.Add Diagnostic') }}</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
