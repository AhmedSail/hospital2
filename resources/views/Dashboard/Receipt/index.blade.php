...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">{{ __('side_bar.Finance') }}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{ __('Finance.Catch Receipt') }} </span>
						</div>
					</div>
				</div>
				<!-- breadcrumb -->
                                ...
                                <div class="card-header pb-0">
                                    <div class="d-flex justify-content-between">
                                        <a href="{{ route('Receipts.create') }}" class="btn btn-primary" role="button"
                                           aria-pressed="true">{{ __('Finance.Add Receipt') }}</a>
                                    </div>
                                </div>
                                <div class="card-body">
                                           ...
                                           @foreach($receipts as $receipt)
                                               <tr>
                                                   ...
                                                   <td>
                                                       ...
                                                       <a class="btn btn-sm btn-success" href="{{ route('Receipts.show', $receipt->id) }}" target="_blank" title="{{ __('Finance.Print Catch Receipt') }}"><i class="las la-print"></i></a>
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <form action="{{ route('Receipts.destroy', $receipt->id) }}"
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <h5>{{ __('Finance.Do Uou Need Delete This Receipt') }}</h5>
                                                            </div>
