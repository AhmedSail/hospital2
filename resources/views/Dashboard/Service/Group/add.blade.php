...
@endsection
@section('content')
    <form action="{{ route('GroupService.store') }}" method="post" autocomplete="off">
        @csrf
        <div class="modal-body">
            ...
            <div>
                ...
                <select name="Services[]"
                    ...
                    <option name="Services[]" value="" disabled>
                        {{ __('doctor.-- حدد المواعيد --') }}</option>
                    @foreach ($services as $service)
                        @if ($service->status == 1)
                            <option data-price="{{ $service->price }}" value="{{ $service->id }}">{{ $service->price }}$
                                {{ $service->name }}</option>
                        @endif
                    @endforeach
                </select>
            ...
            <div>
                ...
                <input type="text" class="form-control" id="totalBeforeDiscount" disabled>
            </div>
            ...
            <div>
                ...
                <input type="text" class="form-control" id="totalAfterDiscount" disabled>
            </div>
            <div>
                <label for="">{{ __('service.Tax Value') }}</label>
                <input id="taxInput" type="number" name="tax"
            ...
            <div>
                ...
                <input id="totalWithTax" type="text" class="form-control" disabled value="{{ $Total_with_tax }}">
